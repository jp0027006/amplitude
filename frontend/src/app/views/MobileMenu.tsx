            ...
            <li key={navItemIndex} className="py-2">
              ...
              {expandedItem === navItemIndex && navItem.submenuItems && (
                <div className="mt-2 pl-4 border-l-2 border-gray-200">
                  {navItem.submenuItems.map((submenuItem, submenuItemIndex) => (
                    <div key={submenuItemIndex} className="py-2">
                      {submenuItem.ImageTitleDescriptionLink && (
                        <div className="py-2">
                          <Link
                            href={
                              submenuItem.ImageTitleDescriptionLink.submenuLink
                                .link?.link || "/"
                            }
                      ...
                      {submenuItem.LinkDescriptionIcon && (
                        <div className="space-y-4 mt-2">
                          {Object.entries(
                            submenuItem.LinkDescriptionIcon.reduce(
                              (acc, item) => {
                              ...
                              {} as Record<
                                string,
                                typeof submenuItem.LinkDescriptionIcon
                              >
                            )
